...
l.closePath();ja(l,E,j);ba(l,E,j);j.load&&j.load.call(p,n);j.layer&&d(p).drawLayers({clear:C,index:j.index+1})}}var m=this,r,t,l,E,j=D(new G,n),q,u;r=j.source;u=r.getContext;r.src||u?q=r:r&&(I.source===r?q=I._source:(q=new ga,q.src=r,I.source=r,I._source=q));for(t=0;t<m.length;t+=1)if(r=m[t],l=F(m[t]))n=K(m[t],j,n,p),j.visible&&q&&(q.complete||u?k(r,t,l)():(d(q).bind("load",k(r,t,l)),q.src=q.src));return m};d.fn.createPattern=d.fn.pattern=function(p){function n(){l=m.createPattern(t,r.repeat);r.load&&
r.load.call(k[0],l)}var k=this,m,r=D(new G,p),t,l,q;(m=F(k[0]))?(q=r.source,"function"===typeof q?(t=aa.createElement("canvas"),t.width=r.width,t.height=r.height,p=F(t),q.call(t,p),n()):(p=q.getContext,q.src||p?t=q:(t=new ga,t.src=q),t.complete||p?n():(d(t).bind("load",n),t.src=t.src))):l=e;return l};d.fn.createGradient=d.fn.gradient=function(d){var n;d=D(new G,d);var k=[],m,r,q,l,E,j,H;if(n=F(this[0])){d.x1=d.x1||0;d.y1=d.y1||0;d.x2=d.x2||0;d.y2=d.y2||0;n=d.r1!==e||d.r2!==e?n.createRadialGradient(d.x1,
