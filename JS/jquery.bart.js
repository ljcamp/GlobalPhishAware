 ...
 * @copyright (c) 2013 Timo Gnambs (http://timo.gnambs.at)
 * @license   Dual licensed under the MIT and GPL licenses:
 *              http://www.opensource.org/licenses/mit-license.php
 *              http://www.gnu.org/licenses/gpl.html
 * @requires  jQuery v1.9.1
 * @requires  jCanvas v13.04.05
 * @version   2013-05-08
 */
...
(function($) {
     ...
     *   jquery-1.9.1.min.js    (the script library for DOM manipulation)
     *   jquery.jcanvas.min.js  (jquery plugin for canvas manipulation)
    ...
    $.fn.bart = function( method ) {
        ...
        var opts = {
            ...
            frmids_pumps:    ['i1p','i2p'],  // optional ids of hidden form elements to save 
                                             //    number of pumps for each balloon
            frmids_exploded: ['i1e','i2e'],  // optional ids of hidden form elements to save 
