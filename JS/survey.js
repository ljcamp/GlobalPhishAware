...
var skill_questions = [
  {
  ...
  },
    {
        ...
        options:[
            'Pretending to be someone or a company to steal users’ information',
  ...
  {
    type:'radio',
    question:'How many years of working experience do you have in network operation and security area?',
    options: [
      '10+ years',
      '5-10 years',
      '1-5 years',
  ...
  {
    type:'checkall',
    question:'What information and network security tools do you use regularly? (Please mark all those that apply)',
    options: [
      'Firewall',
      'Anti-virus',
