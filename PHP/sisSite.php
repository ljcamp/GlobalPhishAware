...
<H3>INTRODUCTION</H3><P>
		...
		<P><B>Do not complete this study unless you can read and understand English are at least 18 years old.</B></P>		
<?php
...
?>
		<P>This study is funded by National Science Foundation(NSF) grant "Living in the Internet of Things".
        </P>
		<H3>STUDY PURPOSE</H3>
		...
		<strong>This study consists of three tasks. </strong> The first task is a balloon experiment. The second task is to complete a brief experiment, and the third task is to complete a demographic and informational survey. The experimental task involves visiting a series of websites and deciding whether or not they are secure enough to sign-in.  The final survey involves a series of questions concerning your practical experience and knowledge about security on the Internet. The combined time for completing these three tasks will be approximately 15-25 minutes.  
            <?php
            if($_SESSION['type'] == 'mturk'){
...
?>
<H3>CONTACT</H3>
		If you have questions at any time about the study or the procedures, you may contact Sanchari Das at sancdas@indiana.edu. You can also contact our group in regards to this study by calling (812) 856-7986.
