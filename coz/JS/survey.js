...
var skill_questions = [
...

  {
    ...
    optionsRU:[
      ...
      'Передача привилегий корня обычному пользователю без использования графического интерфейса.',
    ...
    optionsBG:[
      ...
      'Предаването на коренните привилегии на обикновен потребител без използването на GUI.',
